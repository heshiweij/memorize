package com.xju.memorize.component.bar;
...
public class TopBar extends GradientBar {
    ...
    private void init() {
        ...
        left_layout_back = (RelativeLayout) findViewById(R.id.left_layout_back);
        left_layout_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (null != l)
                    l.onLeftBackTextImageClick();
            }
        });
    ...
    public void setTopBarBackgroundIcon(int color) {
        topBarLayout.setBackground(getResources().getDrawable(color));
    }
    ...
    public void hideLeftTextImage() {
        left_layout_back.setVisibility(View.VISIBLE);
        leftLayout.setVisibility(View.GONE);
    }

    public void hideLeftTextImageGone() {
        left_layout_back.setVisibility(View.GONE);
        leftLayout.setVisibility(View.GONE);
    }
