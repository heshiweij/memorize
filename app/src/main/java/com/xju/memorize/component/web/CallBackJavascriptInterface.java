...
public class CallBackJavascriptInterface {
    ...
    public void routeSuccess() {
        if (null != javaScriptCallBackListener) {
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    javaScriptCallBackListener.routeSuccess();
                }
            });
        }
    }
    ...
    @JavascriptInterface
    public void routeFail(final String msg) {
        if (null != javaScriptCallBackListener) {
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    javaScriptCallBackListener.routeFail(msg);
                }
            });
        }
    }
    ...
    public void payResult() {
        if (null != javaScriptCallBackListener) {
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    javaScriptCallBackListener.payResult();
                }
            });
        }
    }
    ...
    public void verifyResult() {
        if (null != javaScriptCallBackListener) {
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    javaScriptCallBackListener.verifyResult();
                }
            });
        }
    }
